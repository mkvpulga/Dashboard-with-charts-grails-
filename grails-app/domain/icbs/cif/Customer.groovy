...
class Customer{
  ...
  List infobases = [].withLazyDefault {new Infobase()}  
    ...
    static hasMany =[contacts:Contact,
                    ...
                    deposits:Deposit,
                    loans:Loan,
                    nonpersonaladditional:NonPersonalAdditional,
					infobases:Infobase
    ...
    static constraints = {
        ...
        dosriCode nullable:false,blank:false //changed
        status nullable:true
        title nullable:false
        civilStatus nullable:false
        customerCode1 nullable:false,blank:false //changed
        customerCode2 nullable:true
        customerCode3 nullable:true
        amla nullable:true
       // pepDescription nullable:false,blank:false //changed
        //nationality nullable:true
         pepDescription nullable:true //changed

        //end lov
        nationality nullable:true
        customerId nullable:true
        customerPepDescription nullable:true
        townBirthPlace nullable:true
    ...
    //    birthPlace maxSize:50 ,validator:{val,obj,errors->
        //comment by jm marquez birthplace converted to LOV
        /*birthPlace maxSize:50 ,validator:{val,obj,errors->
        ...
        typeOfSourceIncome nullable:true
    }
